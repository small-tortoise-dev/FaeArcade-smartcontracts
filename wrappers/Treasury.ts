...
export class Treasury implements Contract {
  ...
  async sendOpenRoom(
    ...
    const body = beginCell()
      .storeUint(0x4f70656e, 32) // Opcode for OpenRoom (auto-generated by Tact)
  ...
  async sendEnterPaid(
    ...
    const body = beginCell()
      .storeUint(0x456e7465, 32) // Opcode for EnterRoom (auto-generated by Tact)
      .storeUint(roomKey, 32)
      .storeCoins(entryFee)
      .endCell()
  ...
  async sendCloseRoom(
    ...
    const body = beginCell()
      .storeUint(0x436c6f73, 32) // Opcode for CloseRoom (auto-generated by Tact)
      .storeUint(roomKey, 32)
      .endCell()
  ...
  async sendDistributePayouts(
    ...
    const body = beginCell()
      .storeUint(0x44697374, 32) // Opcode for DistributePayouts (auto-generated by Tact)
      .storeUint(roomKey, 32)
  ...
  async sendClaimReward(
    ...
    const body = beginCell()
      .storeUint(0x436c6169, 32) // Opcode for ClaimReward (auto-generated by Tact)
      .storeUint(roomKey, 32)
